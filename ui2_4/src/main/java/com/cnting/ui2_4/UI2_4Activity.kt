...
class UI2_4Activity : AppCompatActivity() {
    ...
    val titles = arrayOf("ViewDragHelper拖动排序", "OnDragListener拖动排序", "拖动卡片", "抽屉")
    val layouts =
        intArrayOf(R.layout.drag_helper_sort, R.layout.drag_listener_sort, R.layout.drag_card, R.layout.drawer_view)
