...
public final class TabLayoutMediator {
    ...
    /**
     * A {@link OnPageChangeCallback} class which contains the necessary calls back to
     ...
     * ViewPager2#registerOnPageChangeCallback(OnPageChangeCallback)} without removing
