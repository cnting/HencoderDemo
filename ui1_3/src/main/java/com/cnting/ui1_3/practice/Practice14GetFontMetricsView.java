...
public class Practice14GetFontMetricsView extends View {
...

    {
        ...
        offset = -(fontMetrics.ascent + fontMetrics.descent) / 2;   //原理同Practice13

        Log.d("FontMetrics", "fontMetrics.ascent:" + fontMetrics.ascent + ",fontMetrics.descent:" + fontMetrics.descent + ",fontMetrics.top:" + fontMetrics.top + ",fontMetrics.bottom:" + fontMetrics.bottom);
    }
