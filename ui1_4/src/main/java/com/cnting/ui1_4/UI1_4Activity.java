...
public class UI1_4Activity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
...

    {
        ...
        pageModels.add(new PageModel(R.layout.sample_scale_1, R.string.title_scale_1, R.layout.practice_scale_1));
